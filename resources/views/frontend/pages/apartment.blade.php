...
@section('content')
                            ...
                            <div class="elementor-widget-container">
                                ...
                                <div class="wrap_header_banner  center ">
                                    ...
                                    <div class="header_banner_el "
                                        style="{{ Route::is('ongoing.apartment') ? "background-image: url('" . asset('assets/images/breadcrumbs/Completed.jpg') . "')" : "background-image: url('" . asset('assets/images/breadcrumbs/Completed.jpg') . "')" }}">
                                        ...
                                        <div class="header_breadcrumbs">
                                            <div id="breadcrumbs">
                                                <ul class="breadcrumb">
                                                    ...
                                                    <li>{{ Route::is('ongoing.apartment') ? 'ongoing' : 'completed' }}-apartments
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <h1 class=" header_title">
                                            {{ Route::is('ongoing.apartment') ? 'Ongoing' : 'Completed' }} Apartments </h1>
    ...
    <div data-elementor-type="wp-page" data-elementor-id="4499" class="elementor elementor-4499">
        <section
            class="elementor-section elementor-top-section elementor-element elementor-element-7db11f0 elementor-section-boxed elementor-section-height-default elementor-section-height-default"
            style="margin-bottom: 60px" data-id="7db11f0" data-element_type="section">
            <div class="elementor-container elementor-column-gap-default">
                <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-e4c29f0"
                    data-id="e4c29f0" data-element_type="column">
                    <div class="elementor-widget-wrap elementor-element-populated">
                        <div class="elementor-element elementor-element-648d510 elementor-widget elementor-widget-ova_apartment"
                            data-id="648d510" data-element_type="widget" data-widget_type="ova_apartment.default">
                            <div class="elementor-widget-container">

                                {{-- <div class="ova-apartment three_column">



                                    <div class="ova-apartment-item item-template1">
                                            ...
                                            <div class="ova-media">
                                                ...
                                                <div class="content-front">
                                                    ...
                                                    <div class="apartment-img">
                                                        <img decoding="async"
                                                            src="{{ asset('storage/' . $project->gallery[0]) }}"
                                                            alt="{{ $project->name }}">
                                                    </div>
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <span class="info-list-item-fixed">
                                                            {{ $project->sqft }} ft2 </span>

                                                        <span class="info-list-item">

                                                            <i class="fa fa-bed"
                                                                aria-hidden="true"></i>{{ $project->bedrooms }}
                                                            Bedrooms |
                                                            <i class="fa fa-bath"
                                                                aria-hidden="true"></i>{{ $project->bathrooms }}
                                                            Bathrooms</span>
                                ...
                                <div class="ova-apartment three_column">
                                    ...
                                    @foreach ($projects as $project)
                                        <div class="ova-apartment-item item-template1" style="margin-top: 30px">

                                            <div class="ova-media">

                                                <div class="content-front">

                                                    <a href="{{ route('apartment.inner', ['slug' => $project->slug]) }}">
                                                        <div class="apartment-img">
                                                            <img decoding="async"
                                                                src="{{ asset('storage/' . $project->gallery[0]) }}"
                                                                alt="{{ $project->name }}">
                                                ...
                                                <div class="info">
                                                    ...
                                                    <span class="info-list-item">
                                                        <i class="fa fa-bed" aria-hidden="true"></i>{{ $project->bedrooms }}
                                                        Bedrooms |
                                                        <i class="fa fa-bath"
                                                            aria-hidden="true"></i>{{ $project->bathrooms }}
                                                        Bathrooms</span></span>
                                            ...
                                            <div class="content-back">
                                                ...
                                                <a href="{{ asset('storage/' . $project->gallery[0]) }}"
                                ...
                                @endforeach
                                @if (!empty($upProjects))
                                    @foreach ($upProjects as $upProject)
                                        <div class="ova-apartment-item item-template1" style="margin-top: 30px">
                                            ...
                                            <div class="ova-media">
                                                ...
                                                <div class="content-front">
                                                    ...
                                                    <a href="#">
                                                        <div class="apartment-img">
                                                            <img decoding="async"
                                                                src="{{ asset('storage/' . $upProject->gallery[0]) }}"
                                                                alt="{{ $upProject->name }}"
                                                ...
                                                <div class="info">
                                                    ...
                                                    <span class="info-list-item">
                                                        <i class="fa fa-bed"
                                                            aria-hidden="true"></i>{{ $upProject->bedrooms }}
                                                        Units</span>
